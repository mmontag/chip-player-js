...
typedef struct _dac_control
{
	...
	void * context; // context data sent to chip_reg_write_c
} dac_control;
...
static void daccontrol_SendCommand(dac_control *chip, UINT32 Sample)
{
	...
	case 0x02:	// YM2612
		...
		Data = ChipData[0x00];
		chip_reg_write_c(chip->context, Sample, chip->DstChipType, chip->DstChipID, Port, Command, Data);
		break;
	case 0x11:	// PWM
	...
	case 0x00:	// SN76496
		...
		if (Command & 0x10)
		{
			...
			chip_reg_write_c(chip->context, Sample, chip->DstChipType, chip->DstChipID, 0x00, 0x00, Command | Data);
		}
		else
		{
			...
			chip_reg_write_c(chip->context, Sample, chip->DstChipType, chip->DstChipID, 0x00, 0x00, Command | Data);
			chip_reg_write_c(chip->context, Sample, chip->DstChipType, chip->DstChipID, 0x00, 0x00, Port);
		}
		break;
	case 0x01:	// YM2413
	case 0x03:	// YM2151
	...
	case 0x12:	// AY8910
		Command = (chip->DstCommand & 0x00FF) >> 0;
		Data = ChipData[0x00];
		chip_reg_write_c(chip->context, Sample, chip->DstChipType, chip->DstChipID, 0x00, Command, Data);
		break;
	case 0x06:	// YM2203
	case 0x07:	// YM2608
	case 0x08:	// YM2610/B
