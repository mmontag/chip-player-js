...
static const short waveform[4][WAVEFORM_SIZE] = {
	...
	{ 255, 248, 240, 232, 224, 216, 208, 200, 192, 184, 176, 168,
...
int get_lfo(struct lfo *lfo)
{
	...
	case 4:
		return waveform[3][lfo->phase] * lfo->depth;
	default:
		return 0;
	}
