 ...
 *
 * $Id: gtk_load.c,v 1.11 2007-10-17 13:08:49 cmatsuoka Exp $
 *
...
static int gtk_load (struct xmp_mod_context *, FILE *, const int);
...
static int gtk_test(FILE * f, char *t)
{
	char buf[4];
...
static int gtk_load(struct xmp_mod_context *m, FILE *f, const int start)
{
