 ...
 *
 * $Id: ims_load.c,v 1.11 2007-10-17 13:08:49 cmatsuoka Exp $
 *
...
static int ims_load (struct xmp_mod_context *, FILE *, const int);
...
static int ims_load(struct xmp_mod_context *m, FILE *f, const int start)
{
    int i, j;
    int smp_size;
